    ...
    return (
        <div className="card shadow-md mb-4">
            <div className="card-header py-3 d-flex justify-content-between">
                ...
                <button className="btn btn-sm btn-success" onClick={() => setAddShow(true)}>
                    Add
                </button>
            </div>
            ...
            <AdminCreate onShow={addShow} onHandleClose={() => setAddShow(false)} />

            <AdminEdit onShow={editShow} id={id} onHandleClose={() => setEditShow(false)} />
            <AdminDelete onShow={deleteShow} id={id} onHandleClose={() => setDeleteShow(false)} />
        </div>
    );
};
